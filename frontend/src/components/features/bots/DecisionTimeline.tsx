      ...
      <div className="p-4 space-y-4">
        {logs.map((log, i) => (
          <div key={i} className="flex gap-4 relative">
            ...
            <div className={`z-10 w-8 h-8 rounded-full flex items-center justify-center border-2 border-slate-950 ${
            ...
            <div className="flex-1 bg-slate-950/50 p-3 rounded-lg border border-slate-800/50 hover:border-slate-700 transition-colors">
              <div className="flex items-center justify-between mb-1">
                <div className="flex items-center gap-2">
                  <span className="text-xs font-bold text-slate-400">{log.time}</span>
                  <Badge className={log.action === 'BUY' ? 'bg-red-500/10 text-red-500 border-red-500/20' : 'bg-blue-500/10 text-blue-500 border-blue-500/20'}>
