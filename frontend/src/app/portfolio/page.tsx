...
const holdings = [
  { symbol: 'BTC', name: 'Bitcoin', amount: '0.6923', avgPrice: '78,450,000', currentPrice: '98,200,000', pnl: '+13,674,000', roi: '+17.4%' },
  { symbol: 'ETH', name: 'Ethereum', amount: '4.2150', avgPrice: '4,850,000', currentPrice: '5,220,000', pnl: '+1,559,000', roi: '+7.6%' },
  { symbol: 'SOL', name: 'Solana', amount: '45.12', avgPrice: '215,000', currentPrice: '221,600', pnl: '+297,792', roi: '+3.1%' },
];
        ...
        <Card className="bg-slate-900/50 border-slate-800 backdrop-blur-sm font-sans">
          ...
          <CardContent>
            <div className="text-3xl font-bold font-mono text-white">
              {portfolioSummary.totalValue.toLocaleString()} <span className="text-sm font-normal text-slate-500 ml-1">KRW</span>
            </div>
              ...
              <TableBody>
                {holdings.map((asset) => (
                  <TableRow key={asset.symbol} className="border-slate-800/50 hover:bg-slate-800/30">
                    ...
                    <TableCell className="text-right font-mono text-slate-300">{asset.amount}</TableCell>
                    <TableCell className="text-right">
                      <div className="text-xs font-mono text-slate-400">{asset.avgPrice}</div>
                      <div className="text-sm font-mono text-white font-bold">{asset.currentPrice}</div>
                    </TableCell>
                    <TableCell className="text-right">
                      <div className="text-sm font-mono text-emerald-500 font-bold">{asset.pnl}</div>
                      <Badge variant="outline" className="text-[10px] bg-emerald-500/10 text-emerald-500 border-emerald-500/20 py-0">
                        {asset.roi}
                      </Badge>
                    </TableCell>
                  </TableRow>
